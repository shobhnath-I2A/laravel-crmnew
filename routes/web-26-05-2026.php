...
Route::middleware(['auth', 'verified', 'restrict.ip'])->group(function () {
    ...
    Route::get('/queries', [QueryController::class, 'index'])->name('queries.index')->middleware('module.permission:Query,view');
    ...
    Route::get('/queries/{id}/edit', [QueryController::class, 'edit'])->name('queries.edit')->middleware('module.permission:Query,edit');
