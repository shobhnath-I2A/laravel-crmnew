                ...
                <div id="navigation">
                    <ul class="navigation-menu">
                        <li class="has-submenu">
                            <a href="/" data-toggle="tooltip" data-placement="right" title="" data-original-title="Dashboard">
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu" style="left:46px;top: -80px;">
                                <div>
                                    <li>
                                        <a href="display.html?ga=maketing-dashboard">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Maketing Dashboard
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=clients-group">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Clients Group
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=mailing-templates">
                                            <i class="fa fa-dot-circle-o"aria-hidden="true"></i> Email Templates
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=campaigns">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Campaigns
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=landingpages">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Landing Pages
                                        </a>
                                    </li>
                                </div>
                            </ul>
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu" style="left:46px;top: -230px;">
                                <div>
                                    <li>
                                        <a href="display.html?ga=website-setting">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Website Setting
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=cms-pages">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> CMS Pages
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=home-banner">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Home Banner
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=testimonials">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Testimonials
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=website-destinations">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Website Destinations
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=about-website-destinations">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> About Destinations
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=website-photo-gallery">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Photo Gallery
                                        </a>
                                    </li>
                                    <li>
                                        <a href="display.html?ga=website-blog">
                                            <i class="fa fa-dot-circle-o" aria-hidden="true"></i> Website Blog
                                        </a>
                                    </li>
                                </div>
                            </ul>
                        ...
                        <li class="has-submenu last-elements">
                            <a href="display.html?ga=flyerdesigner" data-toggle="tooltip" data-placement="right" title="" data-original-title="Flyer Designer">
                                <img src="{{ asset('assets/images/icons8-brochure-64.png') }}" width="30">
                            </a>
                        </li>
                    </ul>
                </div>
