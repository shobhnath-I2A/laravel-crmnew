        ...
        <form action="frmaction.html" method="post" enctype="multipart/form-data" name="addeditfrm" target="actoinfrm"
            ...
            <div class="row">
                <div class="col-lg-8" style="padding-left:15px;">
                    ...
                    <div class="row" style="padding-left: 5px;">
                        <div class="col-lg-12">
                            ...
                            <input name="subject" type="text" class="form-control" style="width:100%; margin-bottom:20px;" value="Travel Enquiry for Singapore from i2a Technologies (Query Id- 127504)"
                                autocomplete="off">
                            ...
                            <textarea class="form-control editorclass" id="EmailDetails" name="EmailDetails" rows="15" placeholder="" aria-hidden="true">
                                Dear Sir,&lt;br&gt;Kindly provide the best rates for below enquiry for Singapore at the earliest&lt;br&gt;&lt;br&gt;&lt;table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC"&gt;
                                &lt;tr&gt;
                        ...
                        <div class="form-group" style="overflow:hidden; padding-right:10px; margin-right:0px; margin-top:10px; width:100%;">
                            <div style="margin-top:5px;">
                                <button type="submit" id="savingbutton" class="btn btn-primary" onclick="this.form.submit(); this.disabled=true; this.value='Sending...';" style="float:right;">
                                    <i class="fa fa-paper-plane" aria-hidden="true"></i>&nbsp;Send Mail To Selected Suppliers
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4" style="padding-left:15px;">
                    <h4 class="mt-0 header-title" style="margin-bottom:0px;">
                        <i class="fa fa-check-square-o" aria-hidden="true"></i> Select Supplier</h4>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="2" align="left" valign="top" style="padding-right:10px;">
                                                                <div class="checkbox">
                                                                    <input type="checkbox" name="sendcheck[]" value="100108" style="width: 19px; height: 22px;">
                                                                </div>
                                                            </td>
                                                            <td width="99%" align="left" valign="top">
                                                                ...
                                                                {{ $supplier->submit_name ?? '' }} {{ $supplier->first_name ?? '' }}{{ $supplier->last_name ?? '' }}
                                                                <i class="fa fa-circle" aria-hidden="true" style="color: #b2bad066; margin: 0px 10px; font-size:8px;"></i>{{ $supplier->email ?? '' }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
