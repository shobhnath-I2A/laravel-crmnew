                                ...
                                <div class="card-body">
                                    <h4 class="card-title cardtitle"> Package Theme
                                        ...
                                        <div class="float-right">
                                            <button type="button" class="btn btn-secondary btn-lg waves-effect waves-light"
                                                onclick="openPopup('Add Package Theme','{{ route('package-theme.create') }}')"
                                                data-backdrop="static">Add Package Theme</button>
                                        </div>
                                    </h4>
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($packageTheme as $ptheme)
                                                    <tr>
                                                        <td width="35%" style="cursor:pointer;" onclick="openPopup('Edit Package Theme', '{{ route('package-theme.show', $ptheme->id) }}')">
                                                        ...
                                                        <td width="1%" align="left">
                                                          <span class="badge {{ $ptheme->status == 1 ? 'badge-success' : 'badge-danger' }}"> {{ $ptheme->status == 1 ? 'Active' : 'Inactive' }} </span>
                                                        </td>
                                                        ...
                                                        <td width="12%" align="left">{{ $ptheme->created_at }}</td>
                                                        <td width="1%">
                                                            <a class="dropdown-item neweditpan"
                                                            onclick="openPopup('Edit Package Theme', '{{ route('package-theme.edit', $ptheme->id ) }}')">
                                    ...
                                    <div class="mt-3 pageingouter">
                                        <div style="float: left; font-size: 13px; padding: 7px 11px; border: 1px solid #ededed; background-color: #fff; color: #000;">
                                            Total Records: <strong>{{ $packageThemeCount }}</strong></div>
