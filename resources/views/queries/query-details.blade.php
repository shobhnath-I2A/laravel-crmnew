                         ...
                         <table width="100%" border="0" cellspacing="0" cellpadding="5">
                             <tbody>
                                 <tr>
                                     <td width="41%">
                                         <div class="form-group input-group" style="position:relative;">
                                             <label for="validationCustom02">Internal
                                                 Note</label>
                                             <div class="form-group" style="overflow:hidden;">
                                                 <textarea name="internalnote" id="internalnote" onkeyup="saveinternalnote();" class="form-control" style="width:400px;"
                     ...
                     <table class="table table-hover mb-0"style=" font-size:13px;">
                         ...
                         <tbody>
                             <tr>
                                 ...
                                 <td valign="middle">
                                     <a target="_blank" href="display.html?ga=itineraries&amp;view=1&amp;id=109035"
                                 ...
                                 <td width="1%" valign="middle">
                                     <a target="actoinfrm"
                                         onclick="$('.savingbutton109035').attr('disabled','true');$('.savingbutton109035').text('Inserting...');"
                                         href="actionpage.php?action=insertitinerary&amp;qid=127504&amp;id=109035">
                                         <button type="button"
                                             class="btn btn-info btn-lg waves-effect waves-light savingbutton109035"
                                             id="savingbutton" style="font-size: 14px; padding: 5px 10px;">
                                             <i class="fa fa-plus" aria-hidden="true"></i>
                                             Select
                                         </button>
                                     </a>
                             ...
                             <tr>
                                 ...
                                 <td width="1%" valign="middle"><a target="actoinfrm"
                                         ...
                                         <button type="button"
                                             ...
                                             id="savingbutton" style="font-size: 14px; padding: 5px 10px;"><i
                             ...
                             <tr>
                                 <td width="1%" valign="middle"><a
                                         ...
                                         target="_blank"><img src="" style="width:64px; height:46px;  "></a>
                                 </td>
                                 <td valign="middle"><a target="_blank"
                                         href="display.html?ga=itineraries&amp;view=1&amp;id=109019"
                                         style="color: #000; font-weight: 600;">Trail's
                                         To Singapore &amp; Bali With Flights
                                         Updated-1<div style="color:#999999; font-size:11px; margin-top:2px;">
                             ...
                             <tr>
                                 ...
                                 <td valign="middle"><a target="_blank"
                                         ...
                                         Flights Updated<div style="color:#999999; font-size:11px; margin-top:2px;">
                             ...
                             <tr>
                                 ...
                                 <td valign="middle"><a target="_blank"
                                         ...
                                         for 5N/6D <div style="color:#999999; font-size:11px; margin-top:2px;">
                             ...
                             <tr>
                                 ...
                                 <td valign="middle"><a target="_blank"
                                         ...
                                         for 6N / 7D <div style="color:#999999; font-size:11px; margin-top:2px;">
                             ...
                             <tr>
                                 <td width="1%" valign="middle">
                                     <a href="display.html?ga=itineraries&amp;view=1&amp;id=108908"
                                         target="_blank"><img src="" style="width:64px; height:46px;  "></a>
                                 </td>
                                 <td valign="middle"><a target="_blank"
                                         ...
                                         4N / 5D <div style="color:#999999; font-size:11px; margin-top:2px;">
