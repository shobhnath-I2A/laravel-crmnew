                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="number" name="adult" min="1" value="{{ old('adult', 1) }}"
                                class="form-control reqfield" required>
                            @error('adult')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            <label>Child</label>
                            <input type="number" name="child" min="0" value="{{ old('child', 0) }}"
                                class="form-control">
                            @error('child')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="website_cost" value="{{ old('website_cost', 0) }}"
                                class="form-control reqfield" required>
                            @error('website_cost')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="show_in_popular" class="form-control">
                                <option value="0" {{ old('show_in_popular', 0) == 0 ? 'selected' : '' }}>No
                                </option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="show_in_special" class="form-control">
                                <option value="0" {{ old('show_in_special', 0) == 0 ? 'selected' : '' }}>No
                                </option>
