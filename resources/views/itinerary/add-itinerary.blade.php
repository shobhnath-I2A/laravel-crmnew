<div class="wrapper" style="margin-top: 0px; padding:15px;">
    <form class="custom-validation ajax-form" action="{{ route('itineraries.index') }}" target="actoinfrm" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="start_date" id="startDate" value="{{ old('start_date') }}" class="form-control reqfield"
                                required>
                                @error('start_date') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label>End Date <span class="redmtext">*</span></label>
                            <input type="text" name="end_date" id="endDate" value="{{ old('end_date') }}" class="form-control reqfield" required>
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <label>Adult</label>
                            <input type="number" name="adult" min="1" value="{{ old('adult') }}"  class="form-control reqfield" required>
                                @error('adult') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label>Child</label>
                            <input type="number" name="child" min="0" value="{{ old('child') }}" class="form-control">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select name="package_theme_id"  class="form-control">
                                <option value="4" {{ old('package_theme_id') == 4 ? 'selected' : '' }}>Adventure</option>
                                <option value="5" {{ old('package_theme_id') == 5 ? 'selected' : '' }}>Beach Holiday</option>
                                <option value="3" {{ old('package_theme_id') == 3 ? 'selected' : '' }}>Hill Station</option>
                                <option value="6" {{ old('package_theme_id') == 6 ? 'selected' : '' }}>Honeymoon</option>
                                <option value="2" {{ old('package_theme_id') == 2 ? 'selected' : '' }}>Leisure</option>
                                <option value="1" {{ old('package_theme_id') == 1 ? 'selected' : '' }}>Wildlife</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="website_cost" value="{{ old('website_cost') }}" class="form-control reqfield" required>
                            @error('website_cost') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label>Validity <span class="redmtext">*</span></label>
                            <input type="text" name="website_validity" id="websiteValidity" value="{{ old('website_validity') }}" class="form-control reqfield" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="show_in_popular" class="form-control">
                                ...
                                <option value="1" {{ old('show_in_popular') == 1 ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label>Special</label>
                            <select name="show_in_special" class="form-control">
                                ...
                                <option value="1" {{ old('show_in_special') == 1 ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                    </div>
                </div>
