                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="show_website" class="form-control">
                                <option value="0" {{ old('show_website', 0) == 0 ? 'selected' : '' }}>No</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                   name="website_validity"
                                   id="websiteValidity"
                                   value="{{ old('website_validity') }}"
                                   class="form-control reqfield"
                                   required>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="show_in_popular" class="form-control">
                                <option value="0" {{ old('show_in_popular', 0) == 0 ? 'selected' : '' }}>No</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="show_in_special" class="form-control">
                                <option value="0" {{ old('show_in_special', 0) == 0 ? 'selected' : '' }}>No</option>
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    <textarea name="about_package"
                              rows="3"
                              class="form-control">{{ old('about_package') }}</textarea>
                </div>
            </div>
