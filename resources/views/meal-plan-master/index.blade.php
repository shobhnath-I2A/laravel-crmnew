                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-md-12 col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title cardtitle">Meal Plan
                                        ...
                                        <div class="float-right">
                                            <button type="button" class="btn btn-secondary btn-lg waves-effect waves-light"
                                                onclick="openPopup('Add Meal Plan','{{ route('meal-plan-master.create') }}')"
                                                data-backdrop="static">Add Meal Plan</button>
                                        </div>
                                    </h4>
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($mealPlan as $mplan)
                                                    <tr>
                                                        <td width="35%" style="cursor:pointer;" onclick="openPopup('Edit Meal Plan', '{{ route('meal-plan-master.show', $mplan->id) }}')">
                                                        ...
                                                        <td width="1%" align="left">
                                                          <span class="badge {{ $mplan->status == 1 ? 'badge-success' : 'badge-danger' }}"> {{ $mplan->status == 1 ? 'Active' : 'Inactive' }} </span>
                                                        </td>
                                                        ...
                                                        <td width="12%" align="left">{{ $mplan->created_at }}</td>
                                                        <td width="1%">
                                                            <a class="dropdown-item neweditpan"
                                                            onclick="openPopup('Edit Meal Plan', '{{ route('meal-plan-master.edit', $mplan->id ) }}')">
                                    ...
                                    <div class="mt-3 pageingouter">
                                        <div style="float: left; font-size: 13px; padding: 7px 11px; border: 1px solid #ededed; background-color: #fff; color: #000;">
                                            Total Records: <strong>{{ $mealPlanCount }}</strong></div>
